...
-- ----------------------------
INSERT INTO `t_admin_user` VALUES ('1', 'admin', '超级管理员', 'e10adc3949ba59abbe56e057f20f883e', '1593846293', '127.0.0.1', '427', 'tianpian0805@gmail.com', '13121126169', '我是超级管理员', '1', '0', '1222907803', '1451033528');
...
-- ----------------------------
-- Table structure for `t_chatting`
-- ----------------------------
DROP TABLE IF EXISTS `t_chatting`;
CREATE TABLE `t_chatting` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL DEFAULT '0',
  `task_user_id` int NOT NULL DEFAULT '0',
  `apply_user_id` int NOT NULL DEFAULT '0',
  `content` text NOT NULL,
  `file` varchar(225) NOT NULL DEFAULT '',
  `create_time` datetime NOT NULL,
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='チャット表';

-- ----------------------------
-- Records of t_chatting
-- ----------------------------
...
-- ----------------------------
INSERT INTO `t_login_log` VALUES ('42', '1', '127.0.0.1', '本机地址 本机地址  ', 'Chrome(83.0.4103.116)', 'Windows 10', '2020-07-04 16:04:53');
...
-- Records of t_offer
-- ----------------------------
INSERT INTO `t_offer` VALUES ('1', '1', '3', 'dddddddddddddddd', '1', 'hhhhhhhhhhhhhhhhh', 'adsfasdf', '', '', '1', '0', '2020-02-02 15:55:00', '2020-07-05 23:48:39');
INSERT INTO `t_offer` VALUES ('2', '1', '2', '白', '2', 'ddd', 'ggg', '', 'ggg', '1', '0', '2020-02-02 15:55:00', '2020-02-02 15:55:00');
INSERT INTO `t_offer` VALUES ('3', '1', '3', 'dddddddddddddddd', '0', 'hhhhhhhhhhhhhhhhh', 'adsfasdf', '', '', '1', '0', '2020-07-05 23:35:59', '2020-07-05 23:49:26');
...
CREATE TABLE `t_order` (
  ...
  `task_id` int NOT NULL DEFAULT '0' COMMENT 'タスクID',
  `pay_amount` decimal(10,0) NOT NULL DEFAULT '0' COMMENT '実際払う金額',
  `pay_way` tinyint(1) NOT NULL DEFAULT '1' COMMENT '払う方法：1、銀行で口座振替；2、他の',
  `pay_time` datetime NOT NULL COMMENT '実際払う時間',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='注文表';

-- ----------------------------
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES ('1', '12', '222', '1', '1', '1000', '1', '2020-02-01 12:12:12', 'aaa', '1', 'asasas', '2020-02-01 12:12:12', '2020-02-01 12:12:12');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', '366585748@qq.com', 'caicaizi', '', 'e10adc3949ba59abbe56e057f20f883e', '', '', '1', '2020-07-05 23:08:04', '0', 'aaaaaaa', 'bbbbbbbbbb', '1233211312312', '', '2020-07-04 23:52:15', '2020-07-05 23:08:04');

-- ----------------------------
-- Table structure for `t_web_log_001`
-- ----------------------------
...
-- ----------------------------
-- Records of t_web_log_001
-- ----------------------------
INSERT INTO `t_web_log_001` VALUES ('1', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593846283');
INSERT INTO `t_web_log_001` VALUES ('2', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593846283');
INSERT INTO `t_web_log_001` VALUES ('3', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/checklogin.html', 'admin', 'Pub', 'checklogin', 'POST', 'a:3:{s:7:\"account\";s:5:\"admin\";s:8:\"password\";s:6:\"123456\";s:7:\"captcha\";s:4:\"scij\";}', '1593846293');
INSERT INTO `t_web_log_001` VALUES ('4', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593846293');
INSERT INTO `t_web_log_001` VALUES ('5', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593846294');
INSERT INTO `t_web_log_001` VALUES ('6', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_group/index.html', 'admin', 'AdminGroup', 'index', 'GET', 'a:0:{}', '1593846308');
INSERT INTO `t_web_log_001` VALUES ('7', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593847916');
INSERT INTO `t_web_log_001` VALUES ('8', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593847916');
INSERT INTO `t_web_log_001` VALUES ('9', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593847921');
INSERT INTO `t_web_log_001` VALUES ('10', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593847921');
INSERT INTO `t_web_log_001` VALUES ('11', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593847975');
INSERT INTO `t_web_log_001` VALUES ('12', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593847975');
INSERT INTO `t_web_log_001` VALUES ('13', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593856617');
INSERT INTO `t_web_log_001` VALUES ('14', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593856617');
INSERT INTO `t_web_log_001` VALUES ('15', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_group/index.html', 'admin', 'AdminGroup', 'index', 'GET', 'a:0:{}', '1593856732');
INSERT INTO `t_web_log_001` VALUES ('16', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index.html', 'admin', 'AdminNode', 'index', 'GET', 'a:0:{}', '1593856747');
INSERT INTO `t_web_log_001` VALUES ('17', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:2:{s:4:\"type\";s:5:\"group\";s:9:\"module_id\";s:1:\"1\";}', '1593856748');
INSERT INTO `t_web_log_001` VALUES ('18', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:3:{s:4:\"type\";s:4:\"node\";s:9:\"module_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";}', '1593856748');
INSERT INTO `t_web_log_001` VALUES ('19', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_role/index.html', 'admin', 'AdminRole', 'index', 'GET', 'a:0:{}', '1593856749');
INSERT INTO `t_web_log_001` VALUES ('20', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/node_map/index.html', 'admin', 'NodeMap', 'index', 'GET', 'a:0:{}', '1593856751');
INSERT INTO `t_web_log_001` VALUES ('21', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/web_log/index.html', 'admin', 'WebLog', 'index', 'GET', 'a:0:{}', '1593856752');
INSERT INTO `t_web_log_001` VALUES ('22', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/node_map/index.html', 'admin', 'NodeMap', 'index', 'GET', 'a:0:{}', '1593856753');
INSERT INTO `t_web_log_001` VALUES ('23', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_user/index.html', 'admin', 'AdminUser', 'index', 'GET', 'a:0:{}', '1593856755');
INSERT INTO `t_web_log_001` VALUES ('24', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index.html', 'admin', 'AdminNode', 'index', 'GET', 'a:0:{}', '1593856763');
INSERT INTO `t_web_log_001` VALUES ('25', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:2:{s:4:\"type\";s:5:\"group\";s:9:\"module_id\";s:1:\"1\";}', '1593856764');
INSERT INTO `t_web_log_001` VALUES ('26', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:3:{s:4:\"type\";s:4:\"node\";s:9:\"module_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";}', '1593856764');
INSERT INTO `t_web_log_001` VALUES ('27', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_group/index.html', 'admin', 'AdminGroup', 'index', 'GET', 'a:0:{}', '1593856767');
INSERT INTO `t_web_log_001` VALUES ('28', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593857415');
INSERT INTO `t_web_log_001` VALUES ('29', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593857415');
INSERT INTO `t_web_log_001` VALUES ('30', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/banners/index.html', 'admin', 'Banners', 'index', 'GET', 'a:0:{}', '1593857531');
INSERT INTO `t_web_log_001` VALUES ('31', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593861894');
INSERT INTO `t_web_log_001` VALUES ('32', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593861895');
INSERT INTO `t_web_log_001` VALUES ('33', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/logout.html', 'admin', 'Pub', 'logout', 'GET', 'a:0:{}', '1593861902');
INSERT INTO `t_web_log_001` VALUES ('34', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593861905');
INSERT INTO `t_web_log_001` VALUES ('35', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593921836');
INSERT INTO `t_web_log_001` VALUES ('36', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593921836');
INSERT INTO `t_web_log_001` VALUES ('37', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593921911');
INSERT INTO `t_web_log_001` VALUES ('38', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593922495');
INSERT INTO `t_web_log_001` VALUES ('39', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593941335');
INSERT INTO `t_web_log_001` VALUES ('40', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593941335');
INSERT INTO `t_web_log_001` VALUES ('41', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593941336');
...
-- ----------------------------
INSERT INTO `t_web_log_all` VALUES ('1', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593846283');
INSERT INTO `t_web_log_all` VALUES ('2', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593846283');
INSERT INTO `t_web_log_all` VALUES ('3', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/checklogin.html', 'admin', 'Pub', 'checklogin', 'POST', 'a:3:{s:7:\"account\";s:5:\"admin\";s:8:\"password\";s:6:\"123456\";s:7:\"captcha\";s:4:\"scij\";}', '1593846293');
INSERT INTO `t_web_log_all` VALUES ('4', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593846293');
INSERT INTO `t_web_log_all` VALUES ('5', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593846294');
INSERT INTO `t_web_log_all` VALUES ('6', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_group/index.html', 'admin', 'AdminGroup', 'index', 'GET', 'a:0:{}', '1593846308');
INSERT INTO `t_web_log_all` VALUES ('7', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593847916');
INSERT INTO `t_web_log_all` VALUES ('8', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593847916');
INSERT INTO `t_web_log_all` VALUES ('9', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593847921');
INSERT INTO `t_web_log_all` VALUES ('10', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593847921');
INSERT INTO `t_web_log_all` VALUES ('11', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593847975');
INSERT INTO `t_web_log_all` VALUES ('12', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593847975');
INSERT INTO `t_web_log_all` VALUES ('13', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/index.html', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593856617');
INSERT INTO `t_web_log_all` VALUES ('14', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593856617');
INSERT INTO `t_web_log_all` VALUES ('15', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_group/index.html', 'admin', 'AdminGroup', 'index', 'GET', 'a:0:{}', '1593856732');
INSERT INTO `t_web_log_all` VALUES ('16', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index.html', 'admin', 'AdminNode', 'index', 'GET', 'a:0:{}', '1593856747');
INSERT INTO `t_web_log_all` VALUES ('17', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:2:{s:4:\"type\";s:5:\"group\";s:9:\"module_id\";s:1:\"1\";}', '1593856748');
INSERT INTO `t_web_log_all` VALUES ('18', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:3:{s:4:\"type\";s:4:\"node\";s:9:\"module_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";}', '1593856748');
INSERT INTO `t_web_log_all` VALUES ('19', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_role/index.html', 'admin', 'AdminRole', 'index', 'GET', 'a:0:{}', '1593856749');
INSERT INTO `t_web_log_all` VALUES ('20', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/node_map/index.html', 'admin', 'NodeMap', 'index', 'GET', 'a:0:{}', '1593856751');
INSERT INTO `t_web_log_all` VALUES ('21', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/web_log/index.html', 'admin', 'WebLog', 'index', 'GET', 'a:0:{}', '1593856752');
INSERT INTO `t_web_log_all` VALUES ('22', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/node_map/index.html', 'admin', 'NodeMap', 'index', 'GET', 'a:0:{}', '1593856753');
INSERT INTO `t_web_log_all` VALUES ('23', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_user/index.html', 'admin', 'AdminUser', 'index', 'GET', 'a:0:{}', '1593856755');
INSERT INTO `t_web_log_all` VALUES ('24', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index.html', 'admin', 'AdminNode', 'index', 'GET', 'a:0:{}', '1593856763');
INSERT INTO `t_web_log_all` VALUES ('25', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:2:{s:4:\"type\";s:5:\"group\";s:9:\"module_id\";s:1:\"1\";}', '1593856764');
INSERT INTO `t_web_log_all` VALUES ('26', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_node/index', 'admin', 'AdminNode', 'index', 'POST', 'a:3:{s:4:\"type\";s:4:\"node\";s:9:\"module_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";}', '1593856764');
INSERT INTO `t_web_log_all` VALUES ('27', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/admin_group/index.html', 'admin', 'AdminGroup', 'index', 'GET', 'a:0:{}', '1593856767');
INSERT INTO `t_web_log_all` VALUES ('28', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593857415');
INSERT INTO `t_web_log_all` VALUES ('29', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593857415');
INSERT INTO `t_web_log_all` VALUES ('30', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/banners/index.html', 'admin', 'Banners', 'index', 'GET', 'a:0:{}', '1593857531');
INSERT INTO `t_web_log_all` VALUES ('31', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593861894');
INSERT INTO `t_web_log_all` VALUES ('32', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/index/welcome.html', 'admin', 'Index', 'welcome', 'GET', 'a:0:{}', '1593861895');
INSERT INTO `t_web_log_all` VALUES ('33', '1', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/logout.html', 'admin', 'Pub', 'logout', 'GET', 'a:0:{}', '1593861902');
INSERT INTO `t_web_log_all` VALUES ('34', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593861905');
INSERT INTO `t_web_log_all` VALUES ('35', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593921836');
INSERT INTO `t_web_log_all` VALUES ('36', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593921836');
INSERT INTO `t_web_log_all` VALUES ('37', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593921911');
INSERT INTO `t_web_log_all` VALUES ('38', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593922495');
INSERT INTO `t_web_log_all` VALUES ('39', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin', 'admin', 'Index', 'index', 'GET', 'a:0:{}', '1593941335');
INSERT INTO `t_web_log_all` VALUES ('40', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593941335');
INSERT INTO `t_web_log_all` VALUES ('41', '0', '127.0.0.1', '本机地址 本机地址  ', 'Windows 10', 'Chrome(83.0.4103.116)', 'http://www.task.jp/admin/pub/login.html', 'admin', 'Pub', 'login', 'GET', 'a:0:{}', '1593941336');
