<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:63:"G:\www\task\public/../application/admin\view\banners\index.html";i:1520086608;s:63:"G:\www\task\public/../application/admin\view\template\base.html";i:1520086609;s:74:"G:\www\task\public/../application/admin\view\template\javascript_vars.html";i:1520086609;s:62:"G:\www\task\public/../application/admin\view\banners\form.html";i:1520086608;s:60:"G:\www\task\public/../application/admin\view\banners\th.html";i:1520086608;s:60:"G:\www\task\public/../application/admin\view\banners\td.html";i:1520086608;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="名称" name="search" value="<?php echo \think\Request::instance()->param('search'); ?>" >
...
<th width="150">名称</th>
<th width="80"><?php echo sort_by('客户端','type'); ?></th>
<th width="150">位置</th>
<th width="100">图片</th>
<th width="300">跳转链接</th>
<th width="80"><?php echo sort_by('显示','display'); ?></th>
<th width="80"><?php echo sort_by('排序','sort'); ?></th>
            <th width="100">操作</th>
        </tr>
        </thead>
        <tbody>
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "没有广告" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr class="text-c">
            <td><input type="checkbox" name="id[]" value="<?php echo $vo['id']; ?>"></td>
<td><?php echo high_light($vo['title'],\think\Request::instance()->param('search')); ?></td>
<td><?php echo $vo['type_text']; ?></td>
<td><?php echo $vo['position_text']; ?></td>
<td><img src="<?php echo $vo['img_url']; ?>" alt="找不到图片" style="width: 50px;height: 50px"></td>
<td><a href=""><?php echo $vo['jump_url']; ?></a></td>
<td><?php echo !empty($vo['display'])?'是':'否'; ?></td>
<td style="padding: 0">
    <input type="number" name="sort[<?php echo $vo['id']; ?>]" value="<?php echo $vo['sort']; ?>" style="width: 60px;"
        ...
        <?php endforeach; endif; else: echo "没有广告" ;endif; ?>
        </tbody>
    </table>
