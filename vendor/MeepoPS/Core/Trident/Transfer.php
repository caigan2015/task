...
class Transfer {
    ...
    public function callbackTransferConnect($connect){
        ...
        try{
            ...
            Log::write('MeepoPS: Trident execution callback function callbackConnect-' . json_encode(Trident::$callbackList['callbackConnect']) . ' throw exception' . json_encode($e->getMessage()), 'ERROR');
        }
    }
