...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../_css-loader@0.28.9@css-loader/index.js??ref--2-1!../../_postcss-loader@2.0.10@postcss-loader/lib/index.js!./video-js.css", function() {
			var newContent = require("!!../../_css-loader@0.28.9@css-loader/index.js??ref--2-1!../../_postcss-loader@2.0.10@postcss-loader/lib/index.js!./video-js.css");
...
exports.locals = {
	...
	"vjs-icon-square": "vjs-icon-square",
	"vjs-icon-spinner": "vjs-icon-spinner",
	"vjs-icon-subtitles": "vjs-icon-subtitles",
	"vjs-subtitles-button": "vjs-subtitles-button",
	"vjs-subs-caps-button": "vjs-subs-caps-button",
	"vjs-icon-captions": "vjs-icon-captions",
	"vjs-captions-button": "vjs-captions-button",
	"vjs-icon-chapters": "vjs-icon-chapters",
	"vjs-chapters-button": "vjs-chapters-button",
	"vjs-icon-share": "vjs-icon-share",
	"vjs-icon-cog": "vjs-icon-cog",
	"vjs-icon-circle": "vjs-icon-circle",
	"vjs-play-progress": "vjs-play-progress",
	"vjs-volume-level": "vjs-volume-level",
	"vjs-icon-circle-outline": "vjs-icon-circle-outline",
	"vjs-icon-circle-inner-circle": "vjs-icon-circle-inner-circle",
	"vjs-icon-hd": "vjs-icon-hd",
	"vjs-icon-cancel": "vjs-icon-cancel",
	"vjs-control": "vjs-control",
	"vjs-close-button": "vjs-close-button",
	"vjs-icon-replay": "vjs-icon-replay",
	"vjs-ended": "vjs-ended",
	"vjs-icon-facebook": "vjs-icon-facebook",
	"vjs-icon-gplus": "vjs-icon-gplus",
	"vjs-icon-linkedin": "vjs-icon-linkedin",
	"vjs-icon-twitter": "vjs-icon-twitter",
	"vjs-icon-tumblr": "vjs-icon-tumblr",
	"vjs-icon-pinterest": "vjs-icon-pinterest",
	"vjs-icon-audio-description": "vjs-icon-audio-description",
	"vjs-descriptions-button": "vjs-descriptions-button",
	"vjs-icon-audio": "vjs-icon-audio",
	"vjs-audio-button": "vjs-audio-button",
	"vjs-icon-next-item": "vjs-icon-next-item",
	"vjs-icon-previous-item": "vjs-icon-previous-item",
	"vjs-fluid": "vjs-fluid",
	"vjs-16-9": "vjs-16-9",
	"vjs-4-3": "vjs-4-3",
	"vjs-fill": "vjs-fill",
	"vjs-tech": "vjs-tech",
	"vjs-full-window": "vjs-full-window",
	"vjs-user-inactive": "vjs-user-inactive",
	"vjs-hidden": "vjs-hidden",
	"vjs-disabled": "vjs-disabled",
	"vjs-offscreen": "vjs-offscreen",
	"vjs-lock-showing": "vjs-lock-showing",
	"vjs-no-js": "vjs-no-js",
	"vjs-big-play-centered": "vjs-big-play-centered",
	"vjs-controls-disabled": "vjs-controls-disabled",
	"vjs-has-started": "vjs-has-started",
	"vjs-using-native-controls": "vjs-using-native-controls",
	"vjs-error": "vjs-error",
	"vjs-paused": "vjs-paused",
	"vjs-show-big-play-button-on-pause": "vjs-show-big-play-button-on-pause",
	"vjs-menu-button": "vjs-menu-button",
	"vjs-workinghover": "vjs-workinghover",
	"vjs-menu": "vjs-menu",
	...
	"vjs-menu-button-inline": "vjs-menu-button-inline",
	"vjs-slider-active": "vjs-slider-active",
	"vjs-no-flex": "vjs-no-flex",
	"vjs-control-bar": "vjs-control-bar",
	"vjs-audio": "vjs-audio",
	"vjs-control-text": "vjs-control-text",
	"vjs-custom-control-spacer": "vjs-custom-control-spacer",
	...
	"vjs-slider-vertical": "vjs-slider-vertical",
	"vjs-volume-panel-vertical": "vjs-volume-panel-vertical",
	"vjs-poster": "vjs-poster",
	"vjs-live-control": "vjs-live-control",
	...
	"vjs-text-track-display": "vjs-text-track-display",
	"vjs-text-track": "vjs-text-track",
	"vjs-subtitles": "vjs-subtitles",
	"vjs-captions": "vjs-captions",
	...
	"vjs-seeking": "vjs-seeking",
	"vjs-waiting": "vjs-waiting",
	"vjs-spinner-spin": "vjs-spinner-spin",
	"vjs-spinner-fade": "vjs-spinner-fade",
	"vjs-captions-menu-item": "vjs-captions-menu-item",
	"vjs-menu-item-text": "vjs-menu-item-text",
	"vjs-layout-tiny": "vjs-layout-tiny",
	"vjs-layout-x-small": "vjs-layout-x-small",
	"vjs-layout-small": "vjs-layout-small",
	"vjs-text-track-settings": "vjs-text-track-settings",
	"vjs-track-settings-colors": "vjs-track-settings-colors",
	"vjs-track-settings-font": "vjs-track-settings-font",
	"vjs-track-settings-controls": "vjs-track-settings-controls",
	"vjs-label": "vjs-label",
	"vjs-default-button": "vjs-default-button",
	"vjs-spinner-show": "vjs-spinner-show"
};
...
var videojs = __webpack_require__(18);
...
var _videoMin = __webpack_require__(16);
...
$(document).ready(function () {
    ...
    window.player = (0, _videoMin2.default)("video", {
        language: "zh-CN",
        techOrder: ["html5"],
...
module.exports = function ($data) {
    'use strict';
    $data = $data || {};
    var $$out = '', $escape = $imports.$escape, main_img_url = $data.main_img_url, play_url = $data.play_url, title = $data.title, browse_num = $data.browse_num, summary = $data.summary, type = $data.type;
    $$out += '<video id="video" class="video-js vjs-default-skin  vjs-big-play-centered" controls poster="';
    $$out += $escape(main_img_url);
    $$out += '" preload="auto" x5-playsinline="true" playsinline="true" webkit-playsinline="true">\r\n    <source src="';
    $$out += $escape(play_url);
    $$out += '" type="video/mp4">\r\n</video>\r\n<div class="content">\r\n    <div class="weui-media-box weui-media-box_text">\r\n        <h4 class="weui-media-box__title">';
    $$out += $escape(title);
    $$out += '</h4>\r\n        <ul class="weui-media-box__info">\r\n            <li class="weui-media-box__info__meta"><i class="icon-play2"></i>播放次数:';
    $$out += $escape(browse_num);
    $$out += '</li>\r\n            <!--<li class="weui-media-box__info__meta">时间</li>\r\n              <li class="weui-media-box__info__meta weui-media-box__info__meta_extra">其它信息</li> -->\r\n        </ul>\r\n        <p class="weui-media-box__desc">';
    $$out += summary;
    $$out += '</p>\r\n    </div>\r\n</div>\r\n<script>document.title = "';
    $$out += $escape(type == 1 ? '视频回放' : '精彩集锦');
    $$out += '-';
    $$out += $escape(title);
    $$out += '"</script>';
    return $$out;
